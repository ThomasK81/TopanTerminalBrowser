...
6. Included in the sample is a LDAvis of the theta.csv used. You can open the `indexx.html` of [this folder] in your favourite browser to explore the topic model more thoroughly. Combine this approach with TBB to get the best experience.
7. Happy navigating!
